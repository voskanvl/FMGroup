export class ItcSimpleSlider {
    ...
    constructor(t, e) {
        (this._el = 'string' == typeof t ? document.querySelector(t) : t),
            ...
            (this._elItems = this._el.querySelector(
                ItcSimpleSlider.SELECTOR_ITEMS,
            )),
        ...
        if (
            ...
            var i = this._elsItem.length - 1,
                s = -this._elsItem.length;
            (this._elsItem[i].dataset.order = -1),
                (this._elsItem[i].dataset.translate = -this._elsItem.length);
            var r = s * this._width;
            this._elsItem[i].style.transform = 'translateX(' + r + 'px)';
        }
        this._addIndicators(),
    ...
    _setActiveClass() {
        ...
        r && r.classList.add(ItcSimpleSlider.CLASS_NAME_CONTROL_SHOW),
            a && a.classList.add(ItcSimpleSlider.CLASS_NAME_CONTROL_SHOW),
            this._config.loop || 0 !== this._currentIndex
                ? this._config.loop ||
                  this._currentIndex !== this._elsItem.length - 1 ||
                  a.classList.remove(ItcSimpleSlider.CLASS_NAME_CONTROL_SHOW)
    ...
    _move(t) {
        ...
        var i = 'next' === this._direction ? -1 : 1,
            s = this._transform + i;
        'next' === this._direction
            ? ++this._currentIndex > this._elsItem.length - 1 &&
    ...
    _moveTo(t, e) {
        ...
        for (var s = 0; s < Math.abs(t - i); s++) this._move(e);
    }
    ...
    _refreshExtremeValues() {
        ...
        for (var t = 0, e = this._elsItem.length; t < e; t++) {
            var i = this._elsItem[t],
                s = parseInt(i.dataset.order);
            s < this._minOrder
                ? ((this._minOrder = s),
    ...
    _balancingItems() {
        if (this._balancingItemsFlag) {
            var t,
                e,
                i = this._elWrapper.getBoundingClientRect(),
                s = i.width / 2,
                r = this._elsItem.length;
            if ('next' === this._direction) {
                var a = i.left,
                    n = this._$itemWithMinOrder;
                (t = this._minTranslate),
                    n.getBoundingClientRect().right < a - s &&
                        ((n.dataset.order = this._minOrder + r),
                        (t += r),
                        (n.dataset.translate = t),
                        (e = t * this._width),
                        (n.style.transform = 'translateX(' + e + 'px)'),
                        this._refreshExtremeValues());
            } else if ('prev' === this._direction) {
                var _ = i.right,
                    l = this._$itemWithMaxOrder;
                (t = this._maxTranslate),
                    l.getBoundingClientRect().left > _ + s &&
                        ((l.dataset.order = this._maxOrder - r),
                        (t -= r),
                        (l.dataset.translate = t),
                        (e = t * this._width),
                        (l.style.transform = 'translateX(' + e + 'px)'),
                        this._refreshExtremeValues());
            }
    ...
    _addEventListener() {
        ...
        function i(t) {
            if (this._hasSwipeState) {
                var e = 0 === t.type.search('touch') ? t.touches[0] : t,
                    i = this._swipeStartPosX - e.clientX,
                    s = this._swipeStartPosY - e.clientY;
                if (!this._hasSwiping) {
                ...
                var r = i / this._elWrapper.getBoundingClientRect().width,
                    a = this._transform - r;
                this._elItems.classList.add(ItcSimpleSlider.TRANSITION_NONE),
                    (a *= this._width),
                    (this._elItems.style.transform = 'translateX(' + a + 'px)');
            }
        }
        function s(t) {
            if (this._hasSwipeState) {
                ...
                if (0 !== i) {
                    this._config.loop ||
                        (this._currentIndex + 1 >= this._elsItem.length &&
                            i >= 0 &&
                            (i /= 7),
                        this._currentIndex <= 0 && i <= 0 && (i /= 7));
                    var s =
                        (i / this._elWrapper.getBoundingClientRect().width) *
                        100;
                    this._elItems.classList.remove(
                        ItcSimpleSlider.TRANSITION_NONE,
                    ),
                ...
                function (t) {
                    ...
                    if (
                        ...
                        e.classList.contains(
                            ItcSimpleSlider.CLASS_NAME_CONTROL,
                        ))
                    )
                        t.preventDefault(),
        ...
        if (
            ...
            var n = new ResizeObserver(
                function (t) {
                    var e,
                        i = t[0].contentBoxSize,
                        s = t[0].contentRect,
                        r = s ? s.width : (i[0] || i).inlineSize;
                    if (this._width.toFixed(1) !== r.toFixed(1)) {
                        this._autoplay('stop'),
                            this._elItems.classList.add(
                                ItcSimpleSlider.TRANSITION_NONE,
                            ),
                            (this._width = parseInt(r.toFixed(1), 10)),
                            (e =
                                r *
                                parseInt(this._elItems.dataset.translate, 10)),
                            (this._elItems.style.transform =
                                'translateX(' + e + 'px)');
                        for (var a = this._elsItem, n = 0; n < a.length; n++)
                            (e = parseInt(a[n].dataset.translate) * r),
                                (a[n].style.transform =
                                    'translateX(' + e + 'px)');
                        this._config.loop && this._autoplay();
                    }
