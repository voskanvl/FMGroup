...
export class ItcSimpleSlider {
    ...
    constructor(target, config) {
        ...
        console.log('🚀 ~ this._elWrapper', this._elWrapper);
        ...
        if (this._config.loop) {
            ...
            this._elsItem[count].style.transform =
    ...
    _addIndicators() {
        ...
        for (let i = 0, length = this._elsItem.length; i < length; i++) {
            html += `<li class="${
                ItcSimpleSlider.CLASS_NAME_INDICATOR
            }" data-slide-to="${i}">${String(i + 1).padStart(2, '0')}</li>`;
        }
    ...
    _addEventListener() {
        ...
        function onClick(e) {
            ...
            this._autoplay('stop');
            if (
                $target.classList.contains(ItcSimpleSlider.CLASS_NAME_CONTROL)
            ) {
                e.preventDefault();
        ...
        function onSwipeMove(e) {
            ...
            var value =
                diffPosX / this._elWrapper.getBoundingClientRect().width;
        ...
        function onResizeObserver(entries) {
            ...
            newTranslateX =
                newWidth * parseInt(this._elItems.dataset.translate, 10);
